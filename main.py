...
print(basket1.items)
#desc
produkt1 = Product("Produkt 1","brand",2,"screensize","time","AMD Ryzen 9","b","a","helloo")
produkt2 = Product("Produkt 2","brand",2,"screensize","time","AMD Ryzen 9","b","a","helloo")
produkt3 = Product("Produkt 3","brand",4,"screensize","time","intel","b","a","helloo")
produkt4 = Product("Produkt 4","brand ",8,"screensize","time","intel","b","a","helloo")
